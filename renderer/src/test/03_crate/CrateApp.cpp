...
{
	mShaders["standardVS"] = d3dUtil::CompileShader(L"..\\data\\shaders\\03_crate\\Default.hlsl", nullptr, "VS", "vs_5_0");
	mShaders["opaquePS"] = d3dUtil::CompileShader(L"..\\data\\shaders\\03_crate\\Default.hlsl", nullptr, "PS", "ps_5_0");
