...
{
	mvsByteCode = d3dUtil::CompileShader(L"..\\data\\shaders\\06_box\\color.hlsl", nullptr, "VS", "vs_5_0");
	mpsByteCode = d3dUtil::CompileShader(L"..\\data\\shaders\\06_box\\color.hlsl", nullptr, "PS", "ps_5_0");
